...
export QW_DIRECT_MERCHANT_ID="${QW_DIRECT_MERCHANT_ID:-200000000007804}"
export QW_DIRECT_ACCOUNT_NO="${QW_DIRECT_ACCOUNT_NO:-200000000007804}"
...
qw_mode=$QW_MODE
qw_direct_merchant_id=$QW_DIRECT_MERCHANT_ID
qw_direct_account_no=$QW_DIRECT_ACCOUNT_NO
